 ...
 * Blog.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://Blog.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://Blog.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('Blog', []).config(function($sceDelegateProvider) {
 ...
 *        'http://Blog.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="BlogController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("BlogController", function BlogController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('BlogWithSceDisabledBlog', []).config(function($sceProvider) {
